...
import { Trophy, User, Shield, ArrowRight } from 'lucide-react';
    ...
    <div className="min-h-screen bg-black flex items-center justify-center p-6">
      <div className="bg-[#111] max-w-xl w-full rounded-3xl border border-white/10 p-10 overflow-hidden relative shadow-2xl">
        ...
        <div className="mb-10 text-center relative z-10">
          ...
          <h1 className="text-3xl font-black uppercase text-white tracking-tighter">Draft Your Account</h1>
          <p className="text-gray-400 font-medium mt-2">Join AthleteConnect and get in the game.</p>
        </div>
        ...
        <form onSubmit={handleSignUp} className="space-y-6 relative z-10">
          ...
          <div className="grid grid-cols-2 gap-4 mb-8">
            <label className="cursor-pointer group">
              <input type="radio" name="user_type" value="fan" className="peer sr-only" defaultChecked />
              <div className="p-4 rounded-2xl border-2 border-white/10 bg-black/50 hover:bg-white/5 transition-all peer-checked:border-sb-yellow peer-checked:bg-sb-yellow/10 flex flex-col items-center gap-3 text-center h-full">
                ...
                <div>
                  <div className="text-white font-bold uppercase text-xs tracking-widest mb-1">I am a Fan/Brand</div>
            ...
            <label className="cursor-pointer group">
              <input type="radio" name="user_type" value="athlete" className="peer sr-only" />
              <div className="p-4 rounded-2xl border-2 border-white/10 bg-black/50 hover:bg-white/5 transition-all peer-checked:border-sb-yellow peer-checked:bg-sb-yellow/10 flex flex-col items-center gap-3 text-center h-full">
          ...
          <div className="space-y-4">
            <div>
              ...
              <input name="full_name" required placeholder="Jordan Fan" className="w-full bg-black border border-white/10 rounded-xl px-5 py-4 text-white hover:border-white/20 focus:border-sb-yellow focus:ring-1 focus:ring-sb-yellow outline-none transition-all placeholder:text-gray-700 font-medium" />
            </div>
            <div>
